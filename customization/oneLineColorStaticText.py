...
class OneLineColorStaticText(GenStaticText):
    """
    ...
    def __init__(self, parent, delta_point=(0, 0), delta_linespace=0, **kwargs):
        super(OneLineColorStaticText, self).__init__(parent=parent, **kwargs)
